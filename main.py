...
def main_menu():
    ...
    controls_lines = [
        ...
        "The first three keys (left to right) are controlled by 1, 2, and 3 in the top row.",
        "The next three keys (left to right) are controlled by 1, 2, and 3 in the keypad.",
